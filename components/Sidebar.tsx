...
const Sidebar = ({ fullName, avatar, email } : Props) => {
  ...
  return (
    <aside className='sidebar'>
      <Link href="/">
        <Image src="/assets/icons/logo-full-brand.svg" alt='logo' width={160} height={50} className='hidden h-auto bg-brand lg:block' />
        <Image src="/assets/icons/logo-full-brand.svg" alt='logo' width={52} height={52} className='bg-brand lg:hidden' />
      </Link>
